...
public class MileageCalculatorNoConversionCombo extends Application {
	...
	public void start(Stage primaryStage) {
		...
		String[] array = { defaultResult, altResult };
		ObservableList<String> items = FXCollections.observableArrayList(array);
